    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          Time Line of our Journey !
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          We&apos;ve  been crafting visual stories for the past 2 years. Here's a journey of client success.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white/70 dark:bg-black/70 backdrop-blur-sm flex items-center justify-center">
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              <div className="bg-white/20 dark:bg-black/20 backdrop-blur-sm p-6 rounded-xl">
                {item.content}
              </div>
            </div>
          </div>
